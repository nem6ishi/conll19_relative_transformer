...
from code.model.module import rnn_rel_transformer

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")



class RNNRelTransformerModel(RNNTransformerBaseModel):
  def __init__(self, setting, src_lang, tgt_lang):
    ...
    self.encoder = rnn_rel_transformer.TransformerEncoder(
                     src_lang.vocab_size,
    ...
    self.decoder = rnn_rel_transformer.TransformerDecoder(
                     tgt_lang.vocab_size,
